...
>>>>>>> 1f9d2a49bf0bb1058933c30640ec049a52520b10
          ...
          <div>
            ...
            >
              ...
              might be things that you and your team are already great at. We
              want to help you fill in the necessary gaps so you have everything
        ...
        <div>
          <Row style={{ height: "500px" }}>
            ...
            <div className="halfContainer">
              ...
              <p className="information">
                We redesigned the website for an Ayurvedic practitioner to make
                it pop and convey their messaging around Ayurveda. We also
                simplified the user flow to make it easier for people to
                understand the services and book appointments.
              </p>
          ...
          <Row style={{ height: "500px" }}>
            <div className="halfContainer">
              ...
              <p className="information">
                ...
                short-term memory loss gain control of their lives without the
                app dominating it - in collaboration with Tulane University.
              </p>
              <br />
              <div className="alignBtn">
                <a href="">
                  <button className="ProjectBtn">Coming Soon</button>
                </a>
                <br />
                <br />
                <img className="UIicon" src={UI} />
          ...
          <Row style={{ height: "500px" }}>
            ...
            <div className="halfContainer">
              ...
              <p className="information">
                We designed an initial wireframe to bring the idea for this
                start-up in a tangible form to be shared with potential users
                and stakeholders.
              </p>
              <br />
              <div className="alignBtn">
