...
const ServingFresh = () => {
  return (
    <div style={{ height: "auto" }}>
      <div style={{ marginLeft: "10%", marginRight: "10%", height: "auto" }}>
        ...
        <div style={{ float: "left", width: "100%", color: "#707070" }}>
          <div style={{ width: "33%", float: "left", fontSize: "150%" }}>
            <p style={{ float: "left", textAlign: "left", fontWeight: "bold" }}>
              Serving Fresh, LLC
            </p>
          </div>
          <div style={{ width: "33%", float: "left" }}>
            <p style={{ float: "left", fontSize: "75%", textAlign: "left" }}>
              YOUR BUSINESS NAME helps all businesses not only reach, but exceed
              their goals. Our experience helps us lay out a strategy that
              perfectly fits our clients. This collaboration is essential for
              the successful transition from strategy, to plan, to action. Learn
              about some of our past projects below, and get in touch to see
        ...
        <div style={{ float: "left", width: "100%", color: "#52330D" }}>
          <div style={{ width: "25%", float: "left", fontSize: "100%" }}>
            <p style={{ float: "left", textAlign: "left", fontWeight: "bold" }}>
              Before
            </p>
          </div>
          <div style={{ width: "70%", float: "left" }}>
            <img style={{ width: "80%" }} src={Before}></img>
          </div>
        </div>
        <div style={{ float: "left", width: "100%", color: "#52330D" }}>
      ...
      <div style={{ marginLeft: "10%", marginRight: "10%", height: "2900px" }}>
        <div style={{ float: "left", width: "100%", color: "#52330D" }}>
          <div style={{ width: "100%", float: "left", fontSize: "100%" }}>
            <p style={{ float: "left", textAlign: "left", fontWeight: "bold" }}>
              Marketing Content
